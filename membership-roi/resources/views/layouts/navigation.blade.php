<nav x-data="{ open: false }" class="topbar">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('gbp.index')" :active="request()->routeIs('gbp.*') || request()->routeIs('qbp.*')">
                        {{ __('GBP') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('gbp.index')" :active="request()->routeIs('gbp.*') || request()->routeIs('qbp.*')">
                {{ __('GBP') }}
            </x-responsive-nav-link>
