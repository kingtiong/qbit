<nav x-data="{ open: false }" class="bg-gray-950 border-b border-white/10">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-white/10 text-sm leading-4 font-medium rounded-md text-slate-200 bg-gray-950 hover:bg-white/5 hover:text-white focus:outline-none transition ease-in-out duration-150">
